...
class SiAiDeviceConfigNameData : public CDialogEx
{
	DECLARE_DYNAMIC(SiAiDeviceConfigNameData)

public:
	SiAiDeviceConfigNameData(CWnd* pParent = NULL);   // 标准构造函数
	virtual ~SiAiDeviceConfigNameData();

// 对话框数据
	enum { IDD = IDD_AI_SERVER_DEVICE_CONFIG_NAME_DATA_DIALOG };
