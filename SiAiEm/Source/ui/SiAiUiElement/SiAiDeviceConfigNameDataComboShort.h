...
// SiAiDeviceConfigNameDataComboShort 对话框

class SiAiDeviceConfigNameDataComboShort : public CDialogEx
{
	DECLARE_DYNAMIC(SiAiDeviceConfigNameDataComboShort)

public:
	SiAiDeviceConfigNameDataComboShort(CWnd* pParent = NULL);   // 标准构造函数
	virtual ~SiAiDeviceConfigNameDataComboShort();

// 对话框数据
	enum { IDD = IDD_AI_SERVER_DEVICE_CONFIG_NAME_DATA_COMBO_SHORT_DIALOG };
