...
ERROR_T AiNetLayerShortcutForward(AI_NET_STATE *net_state, UINT32_T layer_index) 
{
	...
	AiBaseBoardCmodel1AioShortcutCopyCpu(batch, w_align, h_align, c_align, padding, input, out_w_align, out_h_align, out_c_align, padding_next, output);
	AiBaseLogLayerData(layer_index, "CopyOutputCmodel1", (UINT8_T *)(output), (layer_data->output.length));
	...
	AiBaseLogLayerData(layer_index, "ShortcutAddCmodel1", (UINT8_T *)(layer_short_cut_output), (h_align*w_align*c_align*sizeof(FLOAT_AI_T)));
    AiBaseBoardCmodel1AioShortcutCpu(batch, w_align, h_align, c_align, padding_shortcut, layer_short_cut_output, out_w_align, out_h_align, out_c_align, padding_next, output);
	AiBaseLogLayerData(layer_index, "ShortcutOutputCmodel1", (UINT8_T *)(output), (layer_data->output.length));
	...
	AiBaseLogLayerData(layer_index, "InputCmodel1", (UINT8_T *)(net_state->input), (inputs_align * sizeof(FLOAT_AI_T)));
