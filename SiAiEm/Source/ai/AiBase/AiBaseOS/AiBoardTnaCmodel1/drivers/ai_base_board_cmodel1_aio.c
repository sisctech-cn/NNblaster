    ...
    for (c = 0; c < channels_col; ++c) {
        ...
        for (h = 0; h < height_col; ++h) {
            for (w = 0; w < width_col; ++w) {
                ...
                data_col[col_index] = AiBaseBoardCmodel1AioIm2colGetPixel(data_im, height, width, channels,
    ...
    INT32_T ksize, INT32_T stride, INT32_T pad, FLOAT_AI_T* data_col)
{
	...
	result = AiBaseBoardCmodel1AioIm2colCpuAux(data_im, channels, height, width, ksize, stride, pad, data_col);
	if (result == AI_ERROR_SUCCESS)
		return AI_ERROR_SUCCESS;
#endif
#endif
    AiBaseBoardCmodel1AioIm2colCpu(data_im, channels, height, width, ksize, stride, pad, data_col);
...
* comment  V100
*/
ERROR_T AiBaseBoardCmodel1AioGemmNn(INT32_T m, INT32_T n, INT32_T k, FLOAT_AI_T alpha,
    ...
    FLOAT_AI_T *c, INT32_T ldc)
{
	...
	result = AiBaseBoardCmodel1AioGemmNnAux(m, n, k, alpha, a, lda, b, ldb, c, ldc);
	if (result == AI_ERROR_SUCCESS) {
		return AI_ERROR_SUCCESS;
	}
#endif
...
* comment  V100
*/
ERROR_T AiBaseBoardCmodel1AioGemmTn(INT32_T m, INT32_T n, INT32_T k, FLOAT_AI_T alpha,
    FLOAT_AI_T *a, INT32_T lda,
    FLOAT_AI_T *b, INT32_T ldb,
    FLOAT_AI_T *c, INT32_T ldc)
{
...
* comment  V100
*/
ERROR_T AiBaseBoardCmodel1AioGemmNt(INT32_T m, INT32_T n, INT32_T k, FLOAT_AI_T alpha,
    FLOAT_AI_T *a, INT32_T lda,
    FLOAT_AI_T *b, INT32_T ldb,
    FLOAT_AI_T *c, INT32_T ldc)
{
...
* comment  V100
*/
ERROR_T AiBaseBoardCmodel1AioGemmTt(INT32_T m, INT32_T n, INT32_T k, FLOAT_AI_T alpha,
    FLOAT_AI_T *a, INT32_T lda,
    FLOAT_AI_T *b, INT32_T ldb,
    FLOAT_AI_T *c, INT32_T ldc)
{
...
* comment  V100
*/
ERROR_T AiBaseBoardCmodel1AioGemmCpu(INT32_T ta, INT32_T tb, INT32_T m, INT32_T n, INT32_T k, FLOAT_AI_T alpha,
        FLOAT_AI_T *a, INT32_T lda,
        FLOAT_AI_T *b, INT32_T ldb,
        FLOAT_AI_T beta,
        FLOAT_AI_T *c, INT32_T ldc)
{
    ...
    for (t = 0; t < m; ++t) {
        if (!ta && !tb)
			AiBaseBoardCmodel1AioGemmNn(1, n, k, alpha, a + t*lda, lda, b, ldb, c + t*ldc, ldc);
        else if (ta && !tb)
            AiBaseBoardCmodel1AioGemmTn(1, n, k, alpha, a + t,	   lda, b, ldb, c + t*ldc, ldc);
        else if (!ta && tb)
            AiBaseBoardCmodel1AioGemmNt(1, n, k, alpha, a + t*lda, lda, b, ldb, c + t*ldc, ldc);
        else
            AiBaseBoardCmodel1AioGemmTt(1, n, k, alpha, a + t,     lda, b, ldb, c + t*ldc, ldc);
    }
...
ERROR_T AiBaseBoardCmodel1AioGemm(INT32_T ta, INT32_T tb, INT32_T m, INT32_T n, INT32_T k, FLOAT_AI_T alpha,
        ...
        FLOAT_AI_T *c, INT32_T ldc)
{
    AiBaseBoardCmodel1AioGemmCpu(ta, tb, m, n, k, alpha, a,lda, b, ldb, beta, c, ldc);
	return AI_ERROR_SUCCESS;
}
...
* comment  V100
*/
FLOAT_AI_T AiBaseBoardCmodel1AioLinearActivate(FLOAT_AI_T x)
{
	return (FLOAT_AI_T)(x);
}
FLOAT_AI_T AiBaseBoardCmodel1AioLogisticActivate(FLOAT_AI_T x)
{
	FLOAT_AI_T r, r1;
...
* comment  V100
*/
FLOAT_AI_T AiBaseBoardCmodel1AioLoggyActivate(FLOAT_AI_T x)
{
	FLOAT_AI_T r, r1;
...
* comment  V100
*/
FLOAT_AI_T AiBaseBoardCmodel1AioReluActivate(FLOAT_AI_T x)
{
	FLOAT_AI_T r, r1;
...
* comment  V100
*/
FLOAT_AI_T AiBaseBoardCmodel1AioEluActivate(FLOAT_AI_T x)
{
...
* comment  V100
*/
FLOAT_AI_T AiBaseBoardCmodel1AioSeluActivate(FLOAT_AI_T x) 
{ 
	AiBaseLogErrorCritial();
	return x;
}
...
* comment  V100
*/
FLOAT_AI_T AiBaseBoardCmodel1AioRelieActivate(FLOAT_AI_T x)
{
	AiBaseLogErrorCritial();
	return x;
}
...
* comment  V100
*/
FLOAT_AI_T AiBaseBoardCmodel1AioRampActivate(FLOAT_AI_T x)
{
	AiBaseLogErrorCritial();
	return x;
}
...
* comment  V100
*/
FLOAT_AI_T AiBaseBoardCmodel1AioLeakyActivate(FLOAT_AI_T x)
{
	AiBaseLogErrorCritial();
	return x;
}
...
* comment  V100
*/
FLOAT_AI_T AiBaseBoardCmodel1AioTanhActivate(FLOAT_AI_T x)
{
	AiBaseLogErrorCritial();
	return x;
}
...
* comment  V100
*/
FLOAT_AI_T AiBaseBoardCmodel1AioPlseActivate(FLOAT_AI_T x)
{
	AiBaseLogErrorCritial();
	return x;
}
...
* comment  V100
*/
FLOAT_AI_T AiBaseBoardCmodel1AioStairActivate(FLOAT_AI_T x)
{
	AiBaseLogErrorCritial();
	return x;
}
...
* comment  V100
*/
FLOAT_AI_T AiBaseBoardCmodel1AioHardtanActivate(FLOAT_AI_T x)
{
	AiBaseLogErrorCritial();
	return x;
}
...
* comment  V100
*/
FLOAT_AI_T AiBaseBoardCmodel1AioLhtanActivate(FLOAT_AI_T x)
{
	AiBaseLogErrorCritial();
	return x;
}
...
* comment  V100
*/
FLOAT_AI_T AiBaseBoardCmodel1AioLhtanGradient(FLOAT_AI_T x)
{
	AiBaseLogErrorCritial();
	return x;
}
...
* comment  V100
*/
FLOAT_AI_T AiBaseBoardCmodel1AioHardtanGradient(FLOAT_AI_T x)
{
	AiBaseLogErrorCritial();
	return x;
}
...
* comment  V100
*/
FLOAT_AI_T AiBaseBoardCmodel1AioLinearGradient(FLOAT_AI_T x)
{
	AiBaseLogErrorCritial();
	return x;
}
...
* comment  V100
*/
FLOAT_AI_T AiBaseBoardCmodel1AioLogisticGradient(FLOAT_AI_T x)
{
	AiBaseLogErrorCritial();
	return x;
}
...
* comment  V100
*/
FLOAT_AI_T AiBaseBoardCmodel1AioLoggyGradient(FLOAT_AI_T x)
{
	AiBaseLogErrorCritial();
	return x;
}
...
* comment  V100
*/
FLOAT_AI_T AiBaseBoardCmodel1AioStairGradient(FLOAT_AI_T x)
{
	AiBaseLogErrorCritial();
	return x;
}
...
* comment  V100
*/
FLOAT_AI_T AiBaseBoardCmodel1AioReluGradient(FLOAT_AI_T x)
{
	AiBaseLogErrorCritial();
	return x;
}
...
* comment  V100
*/
FLOAT_AI_T AiBaseBoardCmodel1AioEluGradient(FLOAT_AI_T x)
{
	AiBaseLogErrorCritial();
	return x;
}
...
* comment  V100
*/
FLOAT_AI_T AiBaseBoardCmodel1AioSeluGradient(FLOAT_AI_T x)
{
	AiBaseLogErrorCritial();
	return x;
}
...
* comment  V100
*/
FLOAT_AI_T AiBaseBoardCmodel1AioRelieGradient(FLOAT_AI_T x)
{
	AiBaseLogErrorCritial();
	return x;
}
...
* comment  V100
*/
FLOAT_AI_T AiBaseBoardCmodel1AioRampGradient(FLOAT_AI_T x)
{
	AiBaseLogErrorCritial();
	return x;
}
...
* comment  V100
*/
FLOAT_AI_T AiBaseBoardCmodel1AioLeakyGradient(FLOAT_AI_T x)
{
	AiBaseLogErrorCritial();
	return x;
}
...
* comment  V100
*/
FLOAT_AI_T AiBaseBoardCmodel1AioTanhGradient(FLOAT_AI_T x)
{
	AiBaseLogErrorCritial();
	return x;
}
...
* comment  V100
*/
FLOAT_AI_T AiBaseBoardCmodel1AioPlseGradient(FLOAT_AI_T x)
{
	AiBaseLogErrorCritial();
	return x;
}
...
ERROR_T AiBaseBoardCmodel1AioActivateArrayCpuCustom(FLOAT_AI_T *x, INT32_T n, UINT32_T a)
{
	...
	result = AiBaseBoardCmodel1AioActivateArrayCpuCustomAux(x, n, a);
	if (result == AI_ERROR_SUCCESS)
		return AI_ERROR_SUCCESS;
#endif
    ...
    else if (a == AI_NET_CONFIG_OPTION_VALUE_ACTIVATION_LEAKY_VALUE)
    {
        ...
        for (i = 0; i < n; ++i) {
            x[i] = AiBaseBoardCmodel1AioActivate(x[i], a);
        }
    }
