/**
 ******************************************************************************
 * file    ai_base_board_cmodel_aux_aio.c
 * author  sunlingge
 * version V100
 * brief   the ai base board cmodel aux ai operator driver.
 ******************************************************************************
 */
/*------------------------- Include File ------------------------------------*/
     ...
     INT32_T ksize,  INT32_T stride, INT32_T pad, FLOAT_AI_T* data_col) 
{
    ...
    if (!((height_col == height) && (width_col == width) && (stride == 1) && (pad == 1) && (AiBaseBoardCmodel1IsFmaAvx2() != 0)))
...
ERROR_T AiBaseBoardCmodel1AioActivateArrayCpuCustomAux(FLOAT_AI_T *x, INT32_T n, UINT32_T a)
{
	...
	if (AiBaseBoardCmodel1IsFmaAvx2() == 0)
		return  AI_ERROR_GENERAL;
