...
AI_BASE_FLOAT16_ICVT_INT16 AiBaseFloat16InternalCvtSf16I16(AI_BASE_FLOAT16_F_UINT a, AI_BASE_FLOAT16_ROUNDING_MODE_ENUM rm, UINT32_T *pfflags, BOOL_T is_unsigned)
{
    ...
    AI_BASE_FLOAT16_ICVT_UINT16 r, r_max;
    ...
    if (is_unsigned)
        r_max = (AI_BASE_FLOAT16_ICVT_UINT16)(a_sign - 1);
    else
        r_max = (AI_BASE_FLOAT16_ICVT_UINT16)((AI_BASE_FLOAT16_ICVT_UINT16)1 << (AI_BASE_FLOAT16_ICVT_SIZE16 - 1)) - (AI_BASE_FLOAT16_ICVT_UINT16)(a_sign ^ 1);
    if (a_exp >= 0) {
        if (a_exp <= (AI_BASE_FLOAT16_ICVT_SIZE16 - 1 - AI_BASE_FLOAT16_MANT_SIZE)) {
            a_mant_temp = (a_mant >> AI_BASE_FLOAT16_RND_SIZE);
			r = (AI_BASE_FLOAT16_ICVT_UINT16)(a_mant_temp << a_exp);
            if (r > r_max) {
                /* goto overflow; */
    ...
    if (a_sign)
        r = (AI_BASE_FLOAT16_ICVT_UINT16)((AI_BASE_FLOAT16_ICVT_UINT16)0-r);
    return r;
}
...
{
    return AiBaseFloat16InternalCvtSf16I16(a, rm, pfflags, AI_BASE_FLOAT16_FALSE);
}
...
{
    return AiBaseFloat16InternalCvtSf16I16 (a, rm, pfflags, AI_BASE_FLOAT16_TRUE);
}
...
AI_BASE_FLOAT16_F_UINT AiBaseFloat16InternalCvtI16Sf16(AI_BASE_FLOAT16_ICVT_INT16 a, AI_BASE_FLOAT16_ROUNDING_MODE_ENUM rm, UINT32_T *pfflags, BOOL_T is_unsigned)
{
    ...
    AI_BASE_FLOAT16_ICVT_UINT16 r, mask;
    int l;
    ...
    l = AI_BASE_FLOAT16_ICVT_SIZE16 - AiBaseFloat16ClzU16(r) - (AI_BASE_FLOAT16_F_SIZE - 1);
    if (l > 0) {
        mask = r & (((AI_BASE_FLOAT16_ICVT_UINT16)1 << l) - 1);
        r = (r >> l) | ((r & mask) != 0);
        a_exp += l;
    }
    a_mant = r;
...
{
    return AiBaseFloat16InternalCvtI16Sf16(a, rm, pfflags, AI_BASE_FLOAT16_FALSE);
}
...
{
    return AiBaseFloat16InternalCvtI16Sf16(a, rm, pfflags, AI_BASE_FLOAT16_TRUE);
}
