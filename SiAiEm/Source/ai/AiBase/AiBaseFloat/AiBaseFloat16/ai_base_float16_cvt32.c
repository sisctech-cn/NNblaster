...
AI_BASE_FLOAT16_ICVT_INT32 AiBaseFloat16InternalCvtSf16I32(AI_BASE_FLOAT16_F_UINT a, AI_BASE_FLOAT16_ROUNDING_MODE_ENUM rm, UINT32_T *pfflags, BOOL_T is_unsigned)
{
    ...
    AI_BASE_FLOAT16_ICVT_UINT32 r, r_max;
    ...
    if (is_unsigned)
        r_max = (AI_BASE_FLOAT16_ICVT_UINT32)a_sign - 1;
    else
        r_max = (AI_BASE_FLOAT16_ICVT_UINT32)((AI_BASE_FLOAT16_ICVT_UINT32)1 << (AI_BASE_FLOAT16_ICVT_SIZE32 - 1)) - (AI_BASE_FLOAT16_ICVT_UINT32)(a_sign ^ 1);
    if (a_exp >= 0) {
        if (a_exp <= (AI_BASE_FLOAT16_ICVT_SIZE32 - 1 - AI_BASE_FLOAT16_MANT_SIZE)) {
            a_mant_temp = (a_mant >> AI_BASE_FLOAT16_RND_SIZE);
			r = (AI_BASE_FLOAT16_ICVT_UINT32)(a_mant_temp << a_exp);
            if (r > r_max) {
                /* goto overflow; */
    ...
    if (a_sign)
        r = (AI_BASE_FLOAT16_ICVT_UINT32)((AI_BASE_FLOAT16_ICVT_UINT32)0-r);
    return r;
}
...
{
    return AiBaseFloat16InternalCvtSf16I32(a, rm, pfflags, AI_BASE_FLOAT16_FALSE);
}
...
{
    return AiBaseFloat16InternalCvtSf16I32 (a, rm, pfflags, AI_BASE_FLOAT16_TRUE);
}
...
AI_BASE_FLOAT16_F_UINT AiBaseFloat16InternalCvtI32Sf16(AI_BASE_FLOAT16_ICVT_INT32 a, AI_BASE_FLOAT16_ROUNDING_MODE_ENUM rm, UINT32_T *pfflags, BOOL_T is_unsigned)
{
    ...
    AI_BASE_FLOAT16_ICVT_UINT32 r, mask;
    INT32_T l_value;
    ...
    l_value = AI_BASE_FLOAT16_ICVT_SIZE32 - AiBaseFloat16ClzU32(r) - (AI_BASE_FLOAT16_F_SIZE - 1);
    if (l_value > 0) {
        mask = r & (((AI_BASE_FLOAT16_ICVT_UINT32)1 << l_value) - 1);
        r = (r >> l_value) | ((r & mask) != 0);
        a_exp += l_value;
    }
...
{
    return AiBaseFloat16InternalCvtI32Sf16(a, rm, pfflags, AI_BASE_FLOAT16_FALSE);
}
...
{
    return AiBaseFloat16InternalCvtI32Sf16(a, rm, pfflags, AI_BASE_FLOAT16_TRUE);
}
...
FLOAT16_T AiBaseFloat16CvtI32F16(INT32_T a) {
	AI_BASE_FLOAT16_ROUNDING_MODE_ENUM rm = AI_BASE_FLOAT16_RM_RTZ;
	UINT32_T fflags;
	FLOAT16_T b;
	AI_BASE_FLOAT16_F_UINT a_unit;

	a_unit = AiBaseFloat16CvtI32Sf16(a, rm, &fflags);
	memcpy(&b, &a_unit, sizeof(AI_BASE_FLOAT16_F_UINT));
