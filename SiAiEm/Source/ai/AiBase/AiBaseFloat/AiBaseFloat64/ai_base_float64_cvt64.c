...
AI_BASE_FLOAT64_ICVT_INT64 AiBaseFloat64InternalCvt32I64(AI_BASE_FLOAT64_F_UINT a, AI_BASE_FLOAT64_ROUNDING_MODE_ENUM rm, UINT32_T *pfflags, BOOL_T is_unsigned)
{
    ...
    AI_BASE_FLOAT64_ICVT_UINT64 r, r_max;
    ...
    if (is_unsigned)
        r_max = (AI_BASE_FLOAT64_ICVT_UINT64)a_sign - 1;
    else
        r_max = ((AI_BASE_FLOAT64_ICVT_UINT64)1 << (64 - 1)) - (AI_BASE_FLOAT64_ICVT_UINT64)(a_sign ^ 1);
    if (a_exp >= 0) {
        if (a_exp <= (64 - 1 - AI_BASE_FLOAT64_MANT_SIZE)) {
            r = (AI_BASE_FLOAT64_ICVT_UINT64)(a_mant >> AI_BASE_FLOAT64_RND_SIZE) << a_exp;
            if (r > r_max)
                goto overflow;
        } else {
        overflow:
...
{
    return AiBaseFloat64InternalCvt32I64(a, rm, pfflags, AI_BASE_FLOAT64_FALSE);
}
...
{
    return AiBaseFloat64InternalCvt32I64 (a, rm, pfflags, AI_BASE_FLOAT64_TRUE);
}
 ...
 */
/* conversions between float and integers */
static AI_BASE_FLOAT64_F_UINT AiBaseFloat64InternalCvtI64Sf32(AI_BASE_FLOAT64_ICVT_INT64 a, AI_BASE_FLOAT64_ROUNDING_MODE_ENUM rm, UINT32_T *pfflags, BOOL_T is_unsigned)
{
    UINT32_T a_sign;
    INT32_T a_exp;
    AI_BASE_FLOAT64_F_UINT a_mant;
    AI_BASE_FLOAT64_ICVT_UINT64 r, mask;
    int l;
    ...
    a_exp = (AI_BASE_FLOAT64_EXP_MASK / 2) + 32 - 2;
    /* need to reduce range before generic float normalization */
    l = 64 - AiBaseFloat64ClzU64(r) - (32 - 1);
    if (l > 0) {
        mask = r & (((AI_BASE_FLOAT64_ICVT_UINT64)1 << l) - 1);
        r = (r >> l) | ((r & mask) != 0);
        a_exp += l;
    }
    a_mant = (UINT32_T)r;
...
{
    return AiBaseFloat64InternalCvtI64Sf32(a, rm, pfflags, AI_BASE_FLOAT64_FALSE);
}
...
{
    return AiBaseFloat64InternalCvtI64Sf32(a, rm, pfflags, AI_BASE_FLOAT64_TRUE);
}
