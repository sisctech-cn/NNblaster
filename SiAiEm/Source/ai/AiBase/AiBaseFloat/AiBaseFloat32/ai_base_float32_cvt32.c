...
AI_BASE_FLOAT32_ICVT_INT32 AiBaseFloat32InternalCvtSf32I32(AI_BASE_FLOAT32_F_UINT a, AI_BASE_FLOAT32_ROUNDING_MODE_ENUM rm, UINT32_T *pfflags, BOOL_T is_unsigned)
{
    ...
    AI_BASE_FLOAT32_ICVT_UINT32 r, r_max;
    ...
    if (is_unsigned)
        r_max = (AI_BASE_FLOAT32_ICVT_UINT32)(a_sign - 1);
    else
        r_max = (AI_BASE_FLOAT32_ICVT_UINT32)((AI_BASE_FLOAT32_ICVT_UINT32)1 << (AI_BASE_FLOAT32_ICVT_SIZE32 - 1)) - (AI_BASE_FLOAT32_ICVT_UINT32)(a_sign ^ 1);
    if (a_exp >= 0) {
        if (a_exp <= (AI_BASE_FLOAT32_ICVT_SIZE32 - 1 - AI_BASE_FLOAT32_MANT_SIZE)) {
            a_mant_temp = (a_mant >> AI_BASE_FLOAT32_RND_SIZE);
			r = (AI_BASE_FLOAT32_ICVT_UINT32)(a_mant_temp << a_exp);
            if (r > r_max) {
                /* goto overflow; */
    ...
    if (a_sign)
        r = (AI_BASE_FLOAT32_ICVT_UINT32)((AI_BASE_FLOAT32_ICVT_UINT32)0-r);
    return r;
}
...
{
    return AiBaseFloat32InternalCvtSf32I32(a, rm, pfflags, AI_BASE_FLOAT32_FALSE);
}
...
{
    return AiBaseFloat32InternalCvtSf32I32 (a, rm, pfflags, AI_BASE_FLOAT32_TRUE);
}
...
AI_BASE_FLOAT32_F_UINT AiBaseFloat32InternalCvtI32Sf32(AI_BASE_FLOAT32_ICVT_INT32 a, AI_BASE_FLOAT32_ROUNDING_MODE_ENUM rm, UINT32_T *pfflags, BOOL_T is_unsigned)
{
    ...
    AI_BASE_FLOAT32_ICVT_UINT32 r, mask;
    int l;
    ...
    l = AI_BASE_FLOAT32_ICVT_SIZE32 - AiBaseFloat32ClzU32(r) - (AI_BASE_FLOAT32_F_SIZE - 1);
    if (l > 0) {
        mask = r & (((AI_BASE_FLOAT32_ICVT_UINT32)1 << l) - 1);
        r = (r >> l) | ((r & mask) != 0);
        a_exp += l;
    }
    a_mant = r;
...
{
    return AiBaseFloat32InternalCvtI32Sf32(a, rm, pfflags, AI_BASE_FLOAT32_FALSE);
}
...
{
    return AiBaseFloat32InternalCvtI32Sf32(a, rm, pfflags, AI_BASE_FLOAT32_TRUE);
}
