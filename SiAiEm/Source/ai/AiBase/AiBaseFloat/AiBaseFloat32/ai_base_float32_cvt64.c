...
AI_BASE_FLOAT32_ICVT_INT64 AiBaseFloat32InternalCvtSf32I64(AI_BASE_FLOAT32_F_UINT a, AI_BASE_FLOAT32_ROUNDING_MODE_ENUM rm, UINT32_T *pfflags, BOOL_T is_unsigned)
{
    ...
    AI_BASE_FLOAT32_ICVT_UINT64 r, r_max;
    ...
    if (is_unsigned)
        r_max = (AI_BASE_FLOAT32_ICVT_UINT64)(a_sign - 1);
    else
        r_max = (AI_BASE_FLOAT32_ICVT_UINT64)((AI_BASE_FLOAT32_ICVT_UINT64)1 << (AI_BASE_FLOAT32_ICVT_SIZE64 - 1)) - (AI_BASE_FLOAT32_ICVT_UINT64)(a_sign ^ 1);
    if (a_exp >= 0) {
        if (a_exp <= (AI_BASE_FLOAT32_ICVT_SIZE64 - 1 - AI_BASE_FLOAT32_MANT_SIZE)) {
            a_mant_temp = (a_mant >> AI_BASE_FLOAT32_RND_SIZE);
			r = (AI_BASE_FLOAT32_ICVT_UINT64)(a_mant_temp << a_exp);
            if (r > r_max) {
                /* goto overflow; */
    ...
    if (a_sign)
        r = (AI_BASE_FLOAT32_ICVT_UINT64)((AI_BASE_FLOAT32_ICVT_UINT64)0-r);
    return r;
}
...
{
    return AiBaseFloat32InternalCvtSf32I64(a, rm, pfflags, AI_BASE_FLOAT32_FALSE);
}
...
{
    return AiBaseFloat32InternalCvtSf32I64 (a, rm, pfflags, AI_BASE_FLOAT32_TRUE);
}
...
AI_BASE_FLOAT32_F_UINT AiBaseFloat32InternalCvtI64Sf32(AI_BASE_FLOAT32_ICVT_INT64 a, AI_BASE_FLOAT32_ROUNDING_MODE_ENUM rm, UINT32_T *pfflags, BOOL_T is_unsigned)
{
    ...
    AI_BASE_FLOAT32_ICVT_UINT64 r, mask;
    int l;
    ...
    l = AI_BASE_FLOAT32_ICVT_SIZE64 - AiBaseFloat32ClzU64(r) - (AI_BASE_FLOAT32_F_SIZE - 1);
    if (l > 0) {
        mask = r & (((AI_BASE_FLOAT32_ICVT_UINT64)1 << l) - 1);
        r = (r >> l) | ((r & mask) != 0);
        a_exp += l;
    }
...
{
    return AiBaseFloat32InternalCvtI64Sf32(a, rm, pfflags, AI_BASE_FLOAT32_FALSE);
}
...
{
    return AiBaseFloat32InternalCvtI64Sf32(a, rm, pfflags, AI_BASE_FLOAT32_TRUE);
}
